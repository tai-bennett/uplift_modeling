...
class EDA:
    ...
    def _class_analysis(self):
        ...
        fig_treatment = px.bar(
            treat_counts, x="treatment", y="counts", title="Treatment Counts"
        )

        save_figure(fig_treatment, self.save_root, "conversion_counts")

        fig_conversion = px.bar(
            conversion_counts, x="conversion", y="counts", title="Conversion Counts"
        )
    ...
    def _cor_analysis(self):
        ...
        fig = px.imshow(
            cor, text_auto=False, aspect="auto", title="Correlation Heatmap"
        )
